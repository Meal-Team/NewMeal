		...
		<div class="row">
			...
			<div style="border: 1px solid #e4e4e4; width: 930px; margin-bottom: 10px; margin: 0 auto; padding: 10px; margin-bottom: 10px;">
				...
				<c:if test="${food_kind_name ne null}">
					<a href="${path}/food?method=findFood&food_kind_id=${food_kind_id}&food_name=${food_name}&pageNow=${pageNow}">${food_kind_name}&nbsp;&nbsp;&gt;</a>
				</c:if>
			...
			<div style="margin: 0 auto; width: 950px;">
				<div class="col-md-6">
					<img style="opacity: 1; width: 400px; height: 350px;" title="" class="medium" src="${food.food_photo}" />
				</div>
				...
				<div class="col-md-6">
					...
					<div style="border-bottom: 1px dotted #dddddd; width: 350px; margin: 10px 0 10px 0;">
						<div>编号：${food.food_id}</div>
					</div>

					<div style="margin: 10px 0 10px 0;">
						价 格: <strong style="color: #ef0101;">￥：${food.food_price}元/份</strong>
					</div>
